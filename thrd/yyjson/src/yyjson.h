...
/** Get a JSON value with JSON Pointer (RFC 6901).
    ...
    Returns NULL if there's no matched value. */
yyjson_api_inline yyjson_mut_val *
yyjson_mut_get_pointern(yyjson_mut_val *val, const char *ptr, size_t len);
...
/** Get a JSON value with JSON Pointer (RFC 6901).
    ...
    Returns NULL if there's no matched value. */
yyjson_api_inline yyjson_mut_val *
yyjson_mut_doc_get_pointer(yyjson_mut_doc *doc, const char *ptr);
...
/** Get a JSON value with JSON Pointer (RFC 6901).
    ...
    Returns NULL if there's no matched value. */
yyjson_api_inline yyjson_mut_val *
yyjson_mut_doc_get_pointern(yyjson_mut_doc *doc, const char *ptr, size_t len);
...
yyjson_api_inline yyjson_val *yyjson_obj_getn(yyjson_val *obj, const char *_key,
  ...
  if (yyjson_likely(yyjson_is_obj(obj) && _key)) {
    ...
    while (len-- > 0) {
      if (key->tag == tag && memcmp(key->uni.ptr, _key, key_len) == 0) {
        return key + 1;
      }
...
unsafe_yyjson_mut_obj_remove(yyjson_mut_val *obj, const char *key,
                             size_t key_len, uint64_t key_tag) {
...
yyjson_api_inline bool yyjson_mut_obj_put(yyjson_mut_val *obj,
  ...
  if (yyjson_likely(yyjson_mut_is_obj(obj) && yyjson_mut_is_str(key))) {
    unsafe_yyjson_mut_obj_remove(obj, key->uni.str, unsafe_yyjson_get_len(key),
                                 key->tag);
    if (yyjson_likely(val)) {
      unsafe_yyjson_mut_obj_add(obj, key, val, unsafe_yyjson_get_len(obj));
    }
...
/* `val` not null, `ptr` start with '/', `len` > 0. */
yyjson_api yyjson_mut_val *
unsafe_yyjson_mut_get_pointer(yyjson_mut_val *val, const char *ptr, size_t len);
